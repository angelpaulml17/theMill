...
def map():
    ...
    if region=='Greater Manchester':
        ...
        if data_level=='LSOA':
            ...
            if demographic_category=='Number of usual residents':
            ...
            elif demographic_category=='Country of birth':
                level='census2021-ts001'
            ...
            elif demographic_category=='Age by single year of age':
                level='census2021-ts001'
            elif demographic_category==' Age by five-year age bands':
                ...
                level='census2021-ts001'
            elif demographic_category=='Sex by single year of age':
                level='census2021-ts001'
            elif demographic_category=='Living arrangements':
            ...
            elif demographic_category=='Number of Households1':
